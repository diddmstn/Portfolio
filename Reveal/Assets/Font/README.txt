...
한자 글꼴은 도스용 한메한글 한자 글꼴 (KS X 1001 부분) 및 jiskan16 (JIS X 0213:2004)에서 추출하였습니다. 하지만 약간의 문제점을 해결하여야 할 것입니다.
...
Description
TTF It is TrueType format.
트루타입 방식을 사용하였습니다.

BDF LINUX reserves its console or terminal.
